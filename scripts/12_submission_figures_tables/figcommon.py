...
FIG_DIRS = {
    1: os.path.join(OUT, "01_main_figures"),
    2: os.path.join(OUT, "01_main_figures"),
    3: os.path.join(OUT, "01_main_figures"),
    4: os.path.join(OUT, "01_main_figures"),
    5: os.path.join(OUT, "01_main_figures"),
}
QC_DIR = os.path.join(OUT, "04_reports/06_visual_qc")
LEGEND_DIR = os.path.join(OUT, "04_reports/07_legend_facts")
SCRIPT_DIR = os.path.join(OUT, "00_scripts")
CK_DIR = os.path.join(OUT, "04_reports/09_checksums")
REP_DIR = os.path.join(OUT, "04_reports")
